...
class ArticleItem(scrapy.Item):
    ...
    articel_id = scrapy.Field()  # 文章链接的id
    ...
    def get_insert_sql(self):
        sql = """
        INSERT INTO Article (articel_id, title, url, content, author, author_url,
        ...
        params = []
        params.append(self.get('articel_id', ''))
...
class AuthorItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        sql = """
        INSERT INTO Author (author_url_object_id, author, author_url, essay_num, articel_num, comment_num,
         registration_time, fans_num, follower_num, integral, Ranking) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) 
         on DUPLICATE KEY UPDATE essay_num=VALUES(essay_num), articel_num=VALUES(articel_num), 
        ...
        params.append(self.get('articel_num', 0))
        params.append(self.get('comment_num', 0))
